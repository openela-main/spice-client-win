...
Source1: spice-client-win-8.10-7-spec.zip
Source2: SpiceVersion.txt
Source3: UsbDk_1.0.22_x64.msi
Source4: spice-client-win-8.10-7-sources.zip
...
/bin/cp %{SOURCE2} %{buildroot}%{spice_data_dir}/
...
%changelog
* Wed Feb 04 2026 Lili Zhu <lizhu@redhat.com> - 8.10-7
- mingw-virt-viewer 9.0-12
  Related: RHEL-139845
  Related: RHEL-145684

* Fri Jan 16 2026 Lili Zhu <lizhu@redhat.com> - 8.10-6
- mingw-virt-viewer 9.0-11
  Related: RHEL-135197
